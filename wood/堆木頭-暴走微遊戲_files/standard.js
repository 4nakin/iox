...
//  }
 ...
 function imgpreload(ims) {
  ...
  function menuswitch(obj) {
   ...
   if(whereto=='game' && ibox_active == 'game') {pausegame();iconfirm('<h1>新遊戲</h1>確定要<br />重新開始遊戲嗎?','restartgame();'); return false;}
  ...
  function ialert(iquestion,idoit,sbtnname) {
   document.getElementById('alertbox_content').innerHTML=iquestion+'<br style="clear:both" /><br /><div style="text-align:center;margin-bottom:10px;"><a href="#" onclick="idismiss();eval(\''+idoit+'\'); return false;" ontouchstart="idismiss();eval(\''+idoit+'\'); return false;"><img src="./i/'+sbtnname+'.png" /></a></div><div><a href="#" onclick="clickMore();"><img src="./i/more.png"  /></a><div>';
