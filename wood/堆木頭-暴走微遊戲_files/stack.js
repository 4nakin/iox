...
function handleclick() {
 ...
 bon=1//Math.floor(stwidth[sts]/10*Math.log(sts+1));
...
function gameover() {
 ...
 if(stscore>theirbest) {
  ...
  theirbest=stscore;
  ialert('<h1>遊戲結束: '+stscore+'分</h1>厲害，你又破紀錄了','restartgame();',"again");
 } else {
  ialert('<h1>遊戲結束: '+stscore+'</h1>再來一次?','restartgame();',"again");
 }
 dp_submitScore(stscore);
