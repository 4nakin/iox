	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://iox.roguelikegames.com",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://iox.roguelikegames.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://iox.roguelikegames.com";
y.url = function() {
	return "http://iox.roguelikegames.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://iox.roguelikegames.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("暴走微遊戲—今日熱門《摩天樓》，等你來戰！"),
	title: function() {
		return "我蓋了一棟和【" + y.c.Gf() + "】一樣高的摩天樓，敢不敢比一下？！"
	}
};
y.c = {
	font: "黑体",
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("暴走微遊戲", "Arial", 12);
	...
	Pi: function() {
		...
		dp_submitScore(a);
		b = _.sprintf("你把摩天樓蓋到了%d層，和【%s】一樣高，分享到臉書和小夥伴比比吧！", a, y.c.Gf());
		A.Ia("end", "score", a);
		b = new y.c.oe(b, "再玩一次",
		function() {
			//this.fg(a)
	...
	fg: function() {
		var a = this.Xp = new y.c.oe("", "再玩一次", this.Oj.bind(this), "玩玩別的", this.pj.bind(this));
		this.addChild(a);
		x.Pd(a)
	},
	Oj: function() {
...
y.c.Gf = function() {
	...
	if (20 <= a && 30 > a) return "長頸鹿";
	if (30 <= a && 40 > a) return "總統府";
	if (40 <= a && 50 > a) return "自由女神";
	if (50 <= a && 60 > a) return "埃菲爾鐵塔";
	if (60 <= a && 70 > a) return "台北101大廈";
	if (70 <= a && 80 > a) return "迪拜塔";
	if (80 <= a && 90 > a) return "泰山";
	if (90 <= a && 100 > a) return "阿爾卑斯山";
	if (100 <= a) return "珠穆朗瑪峰"
};
y.c.Uc = x.Y.extend({
	ctor: function(a, b, c, d) {
		this._super();
...
y.c.Yg = cc.LayerColor.extend({
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("點讚", "ma_button_blue", function() {
				location.href = "https://www.facebook.com/roguelikegames"
			}, this);
