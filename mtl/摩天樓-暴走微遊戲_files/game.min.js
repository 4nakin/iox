		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://game.ioxapp.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://game.ioxapp.com";
y.url = function() {
	return "http://game.ioxapp.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://game.ioxapp.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("點讚", "ma_button_blue", function() {
				location.href = "https://www.facebook.com/rageminigame"
			}, this);
