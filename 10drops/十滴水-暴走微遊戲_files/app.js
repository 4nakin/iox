...
var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        var dropsTitle = cc.createSprite('@剩餘水滴：', {
            xy: [480, 1100],
            fontSize: 34,
        ...
        this.score = 0;
        var scoreTxt = cc.createSprite('@分數: 000000', {
            anchor: [0, 0.5],
            xy: [60, 1100],
            fontSize: 38,
            color: 'rgb(48, 138, 207)'            
        ...
        BoardModel.on('shoot', function(from, to){
            ...
            self.score += 50;
            scoreTxt.setString('分數: ' + ('000000' + self.score).slice(-6));
        });
    ...
    gameOver: function(){
        ...
        //self.wxData.desc = "積少成多，我努力收集了"
        //    +score+'滴水，'
        //    +"超越了"+(0|(percent*100))+"％的好友！你能超過我嗎？";
