...
Ball = new Class({
	...
	rightspeed: 0,
	color: "#fff",
	srcs: "http://game.9g.com/zsqyj/img/shit.png",
	radius: 0,
	expanding: 0,
	sizeChangeCount: 0,
	disabled: false,
...
var ChainRxn = new Class({
	...
	repeatLevel: function (score) {
		...
		document.getElementById('html5').src = "http://game.9g.com/zsqyj/img/html4.png";
	...
	doNextLevel: function (score) {
		...
		this.notifierBox.setStyle("display", "");
		document.getElementById('html5').src = "http://game.9g.com/zsqyj/img/html3.png";
