...
function loadResource() {
	...
	queue.loadManifest({path:RES_DIR + "img/", manifest:[{src:"cloud1.png", id:"cloud1"}, {src:"cloud2.png", id:"cloud2"}, {src:"cloud3.png", id:"cloud3"}, {src:"cloud4.png", id:"cloud4"}, {src:"welcome.png", id:"welcome"}, {src:"logo.png", id:"logo"}, {src:"tag.png", id:"btnframe"}, {src:"start.png", id:"startbtnlabel"}, {src:"top.png", id:"topbtnlabel"},  {src:"game_over.png", id:"gameoverbanner"}, {src:"score.png", id:"scorelabel"}, {src:"line.png", id:"line"}, {src:"green.png", id:"ballgreen"}, {src:"blue.png", id:"ballblue"}, {src:"red.png", id:"ballred"}]}, !1);
	a.forQueue(queue);
	queue.load();
}
function qp_f(a) {
...
Qp_h.prototype.startGame = function () {
	...
	if (!1 == qp_e) {
		...
		qp_e = !1;
		var a = new createjs.Text("在線下面點豬寶寶", "bold 60px Arial", "#ff9d36");
		a.stroke = "white";
